      ...
      <div className="w-screen h-[80px] z-50 bg-black fixed drop-shadow-lg">
        <div className="px-2 flex justify-between items-center w-full h-full">
          ...
          <div className="hidden md:block">
            <a href="https://vce.ac.in/" target="_blank" rel="noopener noreferrer">
              <img src="/logo_vce.png" alt="VCE Logo" className="w-[100px] h-[80px] object-contain" />
            </a>
          </div>
            ...
            {!isGalleryPage && (
              <li className="text-center flex flex-col justify-center">
                <button className="relative inline-flex items-center justify-center p-0.5 mb-2 text-sm font-medium text-white rounded-lg group"
                  ...
                  <span className="px-5 py-2.5 rounded-md">Gallery</span>
                </button>
              </li>
            )}
          </ul>
          ...
          <div className="cursor-pointer" onClick={() => Router.push('/')}>
            <img src="/logo_acumen.png" alt="Acumen Logo" className="w-[100px] h-[80px] object-contain" />
          </div>
        ...
        <ul className={!nav ? 'hidden' : 'absolute bg-black w-full px-8'}>
          ...
          <li className="border-b-2 bg-black border-black text-white w-full cursor-pointer py-2" onClick={() => Router.push('/core-team')}>Core Team</li>
          {!isGalleryPage && (
