...
import { About } from '.';
const Hero = () => (
  <section className={`${styles.yPaddings} bg-[url('/Acumen_25.png')] bg-cover  h-screen text-center flex flex-col justify-start`}>
    ...
    <motion.div
      ...
      className={`${styles.innerWidth} mx-auto p-0 flex flex-col justify-center will-change-transform will-change-opacity`}
    >
